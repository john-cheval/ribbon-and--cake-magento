...
function ContactLeft() {
  return (
    <Box sx={{ position: 'relative' }}>
      ...
      <Box
        sx={{
          padding: { xs: '25px 30px 30px', md: '90px 58px 70px' },
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: { xs: '15px', md: '27px' } }}>
            ...
            >
              <Typography
                component='span'
                sx={{ color: '#000', fontSize: { xs: '12px', sm: '14px', fontWeight: 500 } }}
              >
                Call Us
              </Typography>
      ...
      <Box
        sx={{ position: 'absolute', zIndex: 500, right: { xs: '14px', md: '28px' }, top: '60%' }}
      >
        <Image
          src={svgIcon}
          alt='svgIcon-image'
