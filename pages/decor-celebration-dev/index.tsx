...
const decorSeo = {
  ...
  canonical: '/decor-celebration-dev',
  url: 'https://www.rnbcakes.com/decor-celebration-dev',
...
function DecorCelebrationDevPage(props: DecorCelebrationPageProps) {
...
DecorCelebrationDevPage.pageOptions = {
  Layout: LayoutNavigation,
} as PageOptions

export default DecorCelebrationDevPage
...
export const getStaticProps: GetPageStaticProps = async (context) => {
  ...
  const localCmsPage = await fetchMagentoCmsPage('decor-celebration-dev')
  const cmsPage =
    localCmsPage ??
    (await staticClient
      .query({
        query: cmsPageDocument,
        variables: { urlKey: 'decor-celebration-dev' },
